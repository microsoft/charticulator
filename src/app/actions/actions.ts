...
export class SelectDataRow extends UIAction {
    ...
    public digest() {
        return { name: "SelectDataRow", rowIndex: this.rowIndex, tableName: this.table.name };
    }
}
...
export class AddPlotSegment extends Action {
    constructor(
        public classID: string,
        public mappings: { [name: string]: [Specification.AttributeValue, Specification.Mapping] },
