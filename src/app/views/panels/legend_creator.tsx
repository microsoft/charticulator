                        ...
                        onClick={() => {
                            ...
                            const columns = this.groupBySelector
                                ? this.groupBySelector.value
                                    ? this.groupBySelector.props.multiSelect ? (this.groupBySelector.value as DataFieldSelectorValue[]).map(v => v.expression) :
                            ...
                            if (this.state.legendDataSource === "columnNames") {
                                ...
                                const kind = (this.groupBySelector.value as DataFieldSelectorValue).metadata.kind;
                                switch (kind) {
                            ...
                            this.dispatch(
                                new Actions.SetCurrentTool("legend.custom", JSON.stringify(options))
                            );
                            this.props.onFinish();
                        }}
                    />
