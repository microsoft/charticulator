...
export class Slider extends React.Component<SliderProps, SliderState> {
    ...
    public niceValue(v: number) {
        let digits = Math.ceil(Math.log(this.props.max - this.props.min) / Math.log(10) + 1);
        ...
        return (
            <span className="slider-control">
                <svg width={width} height={height} ref="svg">
                    ...
                    <g className={classNames("knob", ["invalid", this.state.currentValue == null], ["active", this.state.dragging])}>
