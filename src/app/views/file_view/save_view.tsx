            ...
            <section className="charticulator__file-view-content is-fix-width">
                ...
                <section>
                    ...
                    <div className="form-group">
                        <input ref={(e) => inputSaveChartName = e} type="text" required defaultValue={this.mainStore.datasetStore.dataset.name} />
                        <label>Chart Name</label>
                        <i className="bar"></i>
                    </div>
                    <div className="buttons">
                        <ButtonRaised url={R.getSVGIcon("toolbar/save")} text="Save to My Charts" onClick={() => {
                            let name = inputSaveChartName.value.trim();
