...
export class MinimizablePane extends React.Component<MinimizablePaneProps, MinimizablePaneState> {
    ...
    public renderHeader() {
        ...
        return (
            <div className="header" onClick={() => this.setState({ minimized: !this.state.minimized })}>
                <SVGImageIcon url={getSVGIcon(this.state.minimized ? "general/plus" : "general/minus")} />
            ...
            if (this.props.scroll) {
                if (this.props.height != null) {
                    ...
                    return (
                        <div className="minimizable-pane minimizable-pane-scrollable">
                            {this.renderHeader()}
                            <div className="content" style={{ maxHeight: this.props.maxHeight + "px" }}>
                                {this.props.children}
                            </div>
                        </div>
                    );
