...
const colorspaces = new Map<
  string,
  { fromXYZ: ColorConverter; toXYZ: ColorConverter }
>();
const converter_cache = new Map<string, ColorConverter>();

function addColorspace(
  name: string,
  fromXYZ: ColorConverter,
  toXYZ: ColorConverter
) {
