...
export abstract class ConstraintSolver {
    ...
    public abstract attr(map: AttributeMap, name: string, options?: AttributeOptions): Variable;
    ...
    public addEqualToConstant(strength: ConstraintStrength, a: Variable, value: number) {
