...
export class ObjectClassCache {
    ...
    public createMarkClass(parent: Glyphs.GlyphClass, object: Specification.Element, state: Specification.MarkState): Marks.MarkClass {
        return this.createClass(parent, object, state) as Marks.MarkClass;
    }
    public createGlyphClass(parent: PlotSegments.PlotSegmentClass, object: Specification.Glyph, state: Specification.GlyphState): Glyphs.GlyphClass {
        return this.createClass(parent, object, state) as Glyphs.GlyphClass;
    }
    public createPlotSegmentClass(parent: Charts.ChartClass, object: Specification.PlotSegment, state: Specification.PlotSegmentState): PlotSegments.PlotSegmentClass {
        return this.createClass(parent, object, state) as PlotSegments.PlotSegmentClass;
    }
    public createChartElementClass(parent: Charts.ChartClass, object: Specification.ChartElement, state: Specification.ChartElementState): ChartElementClass {
        return this.createClass(parent, object, state) as ChartElementClass;
    }
    public createScaleClass(parent: Charts.ChartClass, object: Specification.Scale, state: Specification.ScaleState): Scales.ScaleClass {
        return this.createClass(parent, object, state) as Scales.ScaleClass;
    }
    public createChartClass(parent: ObjectClass, object: Specification.Chart, state: Specification.ChartState): Charts.ChartClass {
