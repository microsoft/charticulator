...
export class TableLinksClass extends LinksClass {
  ...
  public getGraphics(manager: ChartStateManager): Graphics.Element {
    ...
    for (let i = 0; i < rowIndices.length; i++) {
      ...
      const r1 = rowItem.source_id && tables[0].id2RowGlyphIndex.get(rowItem.source_id.toString());
      const r2 = rowItem.source_id && tables[1].id2RowGlyphIndex.get(rowItem.target_id.toString());
