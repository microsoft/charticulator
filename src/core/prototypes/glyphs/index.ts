...
export interface RectangleGlyphAttributes extends Specification.AttributeMap {
    ...
    ix2: number; iy2: number;
    icx: number; icy: number;
}
...
class RectangleGlyph extends GlyphClass {
    ...
    public attributeNames: string[] = ["x1", "y1", "x2", "y2", "x", "y", "width", "height", "ix1", "iy1", "ix2", "iy2", "icx", "icy"];
    public attributes: { [name: string]: AttributeDescription } = {
        ...
        width: { name: "width", type: "number", mode: "intrinsic", category: "dimensions", displayName: "Width", defaultRange: [30, 200], strength: VariableStrength.WEAKER },
        height: { name: "height", type: "number", mode: "intrinsic", category: "dimensions", displayName: "Height", defaultRange: [30, 200], strength: VariableStrength.WEAKER },
        ix1: { name: "ix1", type: "number", mode: "positional", strength: VariableStrength.NONE },
        iy1: { name: "iy1", type: "number", mode: "positional", strength: VariableStrength.NONE },
        ix2: { name: "ix2", type: "number", mode: "positional", strength: VariableStrength.NONE },
        iy2: { name: "iy2", type: "number", mode: "positional", strength: VariableStrength.NONE },
        icx: { name: "icx", type: "number", mode: "positional", strength: VariableStrength.NONE },
        icy: { name: "icy", type: "number", mode: "positional", strength: VariableStrength.NONE }
    };
    ...
    public buildIntrinsicConstraints(solver: ConstraintSolver): void {
        ...
        solver.addLinear(ConstraintStrength.HARD, 0, [[1, ix2], [-1, ix1]], [[1, width]]);
        solver.addLinear(ConstraintStrength.HARD, 0, [[1, iy2], [-1, iy1]], [[1, height]]);
        ...
        solver.addLinear(ConstraintStrength.HARD, 0, [[1, x]], [[0.5, x2], [0.5, x1], [1, solver.attr(this.state.marks[0].attributes, "x")]]);
