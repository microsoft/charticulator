...
export class TextElement extends MarkClass {
    ...
    public attributeNames: string[] = ["x", "y", "text", "fontFamily", "fontSize", "color", "outline", "opacity", "visible"];
    public attributes: { [name: string]: AttributeDescription } = {
        x: { name: "x", type: "number", mode: "positional" },
        y: { name: "y", type: "number", mode: "positional" },
        text: { name: "text", type: "string", category: "text", displayName: "Text", solverExclude: true, defaultValue: "" },
        ...
        color: { name: "color", type: "color", category: "style", displayName: "Color", solverExclude: true, defaultValue: null },
        outline: { name: "outline", type: "color", category: "style", displayName: "Outline", solverExclude: true, defaultValue: null },
    ...
    public getAttributePanelWidgets(manager: Controls.WidgetManager): Controls.Widget[] {
        ...
        return [
            ...
            manager.mappingEditor("Font", "fontFamily", "font-family", { hints: { rangeString: fontList, stringBehavior: "categorical" }, defaultValue: "Arial" }),
            manager.mappingEditor("Size", "fontSize", "number", { hints: { rangeNumber: [0, 36] }, defaultValue: 14, numberOptions: { showUpdown: true, updownStyle: "font", minimum: 0, updownTick: 2 } }),
            manager.sectionHeader("Anchor & Rotation"),
            manager.row("Anchor X", manager.horizontal([0, 1],
                manager.inputSelect({ property: "alignment", field: "x" }, {
                    type: "radio",
                    icons: ["text-align/left", "text-align/x-middle", "text-align/right"],
            ...
            manager.row("Anchor Y", manager.horizontal([0, 1],
                manager.inputSelect({ property: "alignment", field: "y" }, {
                    type: "radio",
                    icons: ["text-align/top", "text-align/y-middle", "text-align/bottom"],
