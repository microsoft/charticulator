...
export abstract class CoordinateSystem {
    ...
    public abstract transformDirectionAtPoint(x: number, y: number, dx: number, dy: number): Point;
    ...
    public abstract transformDirectionAtPointWithBase(x: number, y: number, dx: number, dy: number): Point;
}
...
export class CartesianCoordinates extends CoordinateSystem {
    ...
    public transformDirectionAtPointWithBase(x: number, y: number, dx: number, dy: number): Point {
        return { x: dx, y: dy };
    }
...
export class PolarCoordinates extends CoordinateSystem {
    constructor(public origin: Point = { x: 0, y: 0 }, public radial1: number = 0, public radial2: number = 1, public distortY: boolean = false) {
        super();
    }
...
export class BezierCurveCoordinates extends CoordinateSystem {
    ...
    constructor(public origin: Point = { x: 0, y: 0 }, curve: MultiCurveParametrization) {
        super();
        this.curve = curve;
    }
